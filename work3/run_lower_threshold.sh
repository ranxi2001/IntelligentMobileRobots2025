...
MAP_PATH="occupancy_grid_threshold0.png"
...
# 启动节点并保存PID
${LMS_MAPPER_CMD} -p map_save_path:=${MAP_PATH} -p map_resolution:=0.1 -p map_threshold:=0 -p filter_points:=true -p filter_threshold:=1.0 -p use_sim_time:=true &
MAPPER_PID=$!
